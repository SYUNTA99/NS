...
/// @file WaterBlock.h
/// @brief 視覚のみの水ブロック GameObject ( v1 placeholder)。
///
/// @details MeshComponent のみを保有する非衝突 GameObject。 player は通り抜け可能で、
///  では「半透明テクスチャ + N·L シェーディング」 の見た目だけを提供する。
/// 流体物理 / 浮力 / 呼吸 ゲージ等は + で本 GameObject を非侵襲に拡張する想定。
...
{
public:
    WaterBlock(NS::Graphics::Mesh* mesh, NS::Graphics::Material* material) noexcept;
