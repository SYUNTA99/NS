...
namespace NS::Graphics
{
    ...
    public:
        ...
        //! @param[in,out] target 非所有の描画先。null で backbuffer へ戻す
        ...
        //! @param[in,out] target 非所有の描画先。null なら backbuffer へ。以降 Size() もこの描画先を返す
