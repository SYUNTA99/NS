...
namespace NS::Object
{
    ...
    private:
        NS::Math::Vector3 m_position{0.0f, 0.0f, 0.0f}; // 親空間の Local position
        NS::Math::Quaternion m_rotation{};              // 親空間の Local rotation
        NS::Math::Vector3 m_scale{1.0f, 1.0f, 1.0f};    // Local scale

        NS::Math::Vector3 m_previousPosition{0.0f, 0.0f, 0.0f}; // 前フレームの position
        NS::Math::Quaternion m_previousRotation{};              // 前フレームの rotation
        NS::Math::Vector3 m_previousScale{1.0f, 1.0f, 1.0f};    // 前フレームの scale
