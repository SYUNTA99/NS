...
namespace NS::Editor
{
    ...
    public:
        ...
        PlaceCommand(NS::GameCore::Level::ObjectInstance prototype,
                     std::int16_t x,
                     std::int16_t y,
                     std::int16_t z,
        ...
        {
            std::size_t bytes = sizeof(PlaceCommand) + NS::GameCore::Level::EstimatedHeapBytes(m_prototype);
            if (m_replaced)
                bytes += NS::GameCore::Level::EstimatedHeapBytes(*m_replaced);
            return bytes;
        }
    ...
    private:
        ...
        NS::GameCore::Level::ObjectInstance m_prototype; // 配置時に複製する複製元
        std::optional<NS::GameCore::Level::ObjectInstance> m_replaced;
