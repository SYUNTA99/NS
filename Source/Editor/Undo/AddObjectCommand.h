...
namespace NS::Editor
{
    ...
    {
    public:
        explicit AddObjectCommand(const NS::GameCore::Level::ObjectInstance& object) noexcept;
        ...
        {
            return sizeof(AddObjectCommand) + NS::GameCore::Level::EstimatedHeapBytes(m_object);
        }

    private:
        NS::GameCore::Level::ObjectInstance m_object;
    };
