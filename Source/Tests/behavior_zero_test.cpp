...
TEST(BehaviorZero, ComponentsDrivenSurvivesJsonRoundTrip)
{
    ...
    NS::Object::SetField(boxEntry, "Half Extents", Vector3{1.0f, 2.0f, 3.0f});
    NS::Object::SetField(boxEntry, "Center Offset", Vector3{0.1f, 0.2f, 0.3f});
    obj.components.push_back(std::move(boxEntry));
    nlohmann::json sphere = NS::Object::MakeComponentEntry("SphereColliderComponent");
    NS::Object::SetField(sphere, "Radius", 0.7f);
    NS::Object::SetField(sphere, "Center Offset", Vector3{0.0f, 1.0f, 0.0f});
    obj.components.push_back(std::move(sphere));
    nlohmann::json capsule = NS::Object::MakeComponentEntry("CapsuleColliderComponent");
    NS::Object::SetField(capsule, "Radius", 0.4f);
    NS::Object::SetField(capsule, "Half Height", 0.9f);
