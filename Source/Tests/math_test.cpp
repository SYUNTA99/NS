...
{
    EXPECT_NEAR(NS::Math::Deg2Rad(0.0f), 0.0f, kEpsilon);
    EXPECT_NEAR(NS::Math::Deg2Rad(180.0f), NS::Math::kPi, kEpsilon);
    EXPECT_NEAR(NS::Math::Deg2Rad(90.0f), NS::Math::kPi * 0.5f, kEpsilon);
}

TEST(NsCoreMath, Rad2DegInvertsDeg2Rad)
{
    EXPECT_NEAR(NS::Math::Rad2Deg(NS::Math::kPi), 180.0f, 1e-3f);
    EXPECT_NEAR(NS::Math::Rad2Deg(NS::Math::Deg2Rad(45.0f)), 45.0f, 1e-3f);
}
...
TEST(NsCoreMath, QuaternionAxisAngleRotatesVector)
{
    ...
    NS::Math::Quaternion q =
        NS::Math::Quaternion::CreateFromAxisAngle(NS::Math::Vector3(0.0f, 0.0f, 1.0f), NS::Math::Deg2Rad(180.0f));
