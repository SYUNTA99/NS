...
{
    GameObject obj;
    NS::Obj::BoxCollider* box = obj.AddComponent<NS::Obj::BoxCollider>();
...
{
    GameObject src;
    NS::Obj::BoxCollider* box = src.AddComponent<NS::Obj::BoxCollider>();
    ...
    NS::Obj::BoxCollider* restoredBox = static_cast<NS::Obj::BoxCollider*>(restored);
